...
import { h, $, $$, tpl, missionName, eventInfo, prefersReduced, waUrl } from "../util.js";
...
export function startFallback({ audio }) {
  ...
  const els = [
    h("header.fb-cover",
      ...
      h("div.fb-art.layer", { "data-depth": "0.1", html: svg("0 0 400 700", `<g class="bob">${crescentSVG(200, 380, 110)}${astronautSVG(205, 420, 0.95, { pose: "sleep", photo: kid.visorPhoto, accent: kid.accentColor })}${gloobiSVG(235, 330, 22, { face: "sleep" })}</g>`) }),
      h("div.fb-cover-text",
    ...
    chapter("fb-walk", svg("0 0 400 460", `${starsSVG(400, 460, 40, 5)}<circle cx="200" cy="900" r="560" fill="#3E8FD6"/><circle cx="200" cy="900" r="575" fill="none" stroke="#6FD6E8" stroke-width="14" opacity=".35"/><g class="bob">${astronautSVG(190, 360, 1.1, { pose: "wave", photo: kid.visorPhoto, accent: kid.accentColor })}${gloobiSVG(300, 150, 26)}</g>`),
